...
export default class NotifService {
    ...
    PushNotification.createChannel(
      {
        ...
        playSound: true,
        importance: Importance.HIGH, // Set the importance to high for heads-up notifications
        vibrate: true,
      },
      created =>
  ...
  localNotif(soundName, payload) {
    ...
    PushNotification.localNotification({
      ...
      bigText: soundName, // (optional) default: "message" prop
      ...
      message: 'Ini push notif pertama kamu', // (required)
